    ...
    contract PlayToken is ERC777ERC20BaseToken {
        /*
        *  Events
        */
        ...
        */
        ...
        function burn(address _who, uint256 _value) public isAdmin {
            _burn(_who, _value);
        }

        function _burn(address _who, uint256 _value) internal {
            require(_value <= mBalances[_who]);
            mBalances[_who] = mBalances[_who] -_value;
            mTotalSupply -= _value;
